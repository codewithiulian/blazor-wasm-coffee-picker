    ...
    public class CoffeeController : ControllerBase
    {
        private List<Coffee> Coffees = new()
        {
            new(1, "Black", "Black coffee is as simple as it gets with ground coffee beans steeped in hot water, served warm. And if you want to sound fancy, you can call black coffee by its proper name: cafe noir.", new string[] { "Coffee" }),
             new(2, "Latte", "As the most popular coffee drink out there, the latte is comprised of a shot of espresso and steamed milk with just a touch of foam. It can be ordered plain or with a flavor shot of anything from vanilla to pumpkin spice.", new string[] { "Coffee" }),
            ...
            new(4, "Americano", "With a similar flavor to black coffee, the americano consists of an espresso shot diluted in hot water.", new string[] { "Espresso", "Hot Water" }),
